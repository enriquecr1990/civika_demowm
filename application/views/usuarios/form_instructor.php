<input type="hidden" id="tipo_usuario" value="instructor">
...
<div class="form-group row">
	<label for="input_codigo_evaluador" class="col-sm-3 col-form-label">Código evaluador</label>
	<div class="col-sm-9">
		<input type="text" id="input_codigo_evaluador" name="codigo_evaluador" data-rule-required="true"
			   placeholder="Código del evaluador" class="form-control"
			   value="<?=isset($usuario) ? $usuario->codigo_evaluador : ''?>">
	</div>
</div>
