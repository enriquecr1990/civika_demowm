...
<div class="form-group row">
	<div class="col-sm-12 text-right">
		<button id="agregar_opcion_pregunta_img_uo" type="button" class="btn btn-outline-success btn-sm agregar_row_comun "
    ...
    <tr>
		...
		<td class="text-center">
			...
			<div id="div_container_img_pregunta_evaluacion_{id}">
				<div>
					<input type="hidden" id="imagen_opcion_pregunta_{id}" class="" name="opcion_pregunta[{id}][id_archivo]" value="<?=isset($opp->id_archivo) ? $opp->id_archivo : ''?>">
...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            ...
            <th rowspan="2">Imagen respuesta</th>
                        ...
                        <div id="div_container_img_pregunta_evaluacion_<?=$index?>">
							<div>
								...
								<img id="imagen_opcion_pregunta_src_<?=$index?>" class="img-thumbnail" style="width: 75px !important;"
									 src="<?=isset($opp->archivo_imagen_respuesta) ? base_url().$opp->archivo_imagen_respuesta->ruta_directorio.$opp->archivo_imagen_respuesta->nombre : base_url().'assets/imgs/logos/no_disponible.png'?>"
