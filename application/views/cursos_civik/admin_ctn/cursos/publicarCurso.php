                    ...
                    <div class="modal-body">
                        ...
                        <div class="row row_form">
                            ...
                            <div class="form-group col-lg-4 col-md-12 col-sm-12">
                                ...
                                <textarea id="input_eje_tematico" class="form-control" placeholder="Eje temático"
                                          data-rule-required="true" name="publicacion_ctn[eje_tematico]"><?=isset($publicacion_ctn) ? $publicacion_ctn->eje_tematico : ''?></textarea>
                            </div>
                        ...
                        <div class="row row_form">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <textarea id="input_descripcion_curso" class="form-control" data-rule-required="true"
                                          name="publicacion_ctn[descripcion]" placeholder="Descripción del curso"><?=isset($publicacion_ctn) ? $publicacion_ctn->descripcion : ''?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row row_form">
                            ...
                            <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                <label for="input_duracion" class="col-form-label">Duración<span class="requerido">*</span></label>
