                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 text-right">
                                <ul>
                                    <li class="mb-1">
                                        <button type="button" class="btn btn-secondary btn-sm btn-pill registrar_nuevo_alumno_curso_publicado_presencial"
                                    ...
                                    <li class="mb-1">
                                        <div class="btn-group" role="group">
                                            <button id="btn_group_lista_asistencia" type="button" class="btn btn-primary btn-pill btn-sm dropdown-toggle"
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btn_group_lista_asistencia">
                                                <?php foreach ($instructores_asignados as $ia): ?>
                                                    <a href="<?=base_url().'DocumentosEXCEL/Lista_Asistencia/'.$publicacion_ctn->id_publicacion_ctn.'/'.$ia->id_instructor_asignado_curso_publicado?>" class="dropdown-item">Instructor: <?=$ia->nombre?></a>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="mb-1">
                                        <div class="btn-group" role="group">
                                            <button id="btn_group_constancias_instructor" type="button" class="btn btn-warning text-white btn-pill btn-sm dropdown-toggle"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btn_group_constancias_instructor">
                                                <?php foreach ($instructores_asignados as $ia): ?>
                                                    <a href="<?=base_url().'DocumentosPDF/constancia_instructor_publicacion_ctn/'.$publicacion_ctn->id_publicacion_ctn.'/'.$ia->id_instructor?>"
                                                       class="dropdown-item" target="_blank"><?=$ia->nombre.' '.$ia->apellido_p?></a>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                    </li>
