    ...
    <div class="table-responsive">
        <table class="table table-striped data-table">
            ...
            <tr>
                ...
                <th colspan="2" class="text-center">Evaluación</th>
                <?php if ($publicacion_ctn->id_catalogo_tipo_publicacion == CURSO_EVALUACION_ONLINE || $publicacion_ctn->id_catalogo_tipo_publicacion = CURSO_EVALUACION_ONLINE): ?>
                    <th class="text-center" rowspan="2">Evidencias</th>
                <?php endif; ?>
            </tr>
            <tr>
                    ...
                    <tr id="registro_alumno_<?= $alumno->id_alumno ?>">
                            ...
                            <ul>
                                ...
                                <li>
                                    <label class="custom-control custom-toggle d-block my-2">
                                        <input type="checkbox"
                                               class="custom-control-input input_asistencia_alumno" <?= $alumno->asistio == 'si' ? 'checked="checked"' : '' ?>
                            ...
                            <?php if ($alumno->id_catalogo_proceso_inscripcion == PROCESO_PAGO_FINALIZADO_INSCRITO): ?>
                                <ul class="text-center">
                                    ...
                                    <?php if (isset($publicacion_ctn->aplica_otra) && $publicacion_ctn->aplica_otra): ?>
                                        <li>
                                            <span class="help-span"><?= $publicacion_ctn->aplica_otra->especifique_otra_constancia ?></span>
                                        </li>
                                        <li class="mb-3">
                        ...
                        <td class="vertical-center">
                            <input class="form-control civika_actualizacion_campo"
                                   ...
                                   placeholder="% de asistencia"
                                   value="<?= isset($alumno->perciento_asistencia) ? $alumno->perciento_asistencia : '' ?>">
                        ...
                        <td class="vertical-center">
                            <input class="form-control civika_actualizacion_campo"
                                   ...
                                   placeholder="Calificación diagnóstica"
                                   value="<?= isset($alumno->calificacion_diagnostica) ? $alumno->calificacion_diagnostica : '' ?>">
                        ...
                        <td class="vertical-center">
                            <input class="form-control civika_actualizacion_campo"
                                   ...
                                   value="<?= isset($alumno->calificacion_final) ? $alumno->calificacion_final : '' ?>">
                        ...
                        <?php if ($publicacion_ctn->id_catalogo_tipo_publicacion == CURSO_EVALUACION_ONLINE || $publicacion_ctn->id_catalogo_tipo_publicacion = CURSO_EVALUACION_ONLINE): ?>
                            <td class="vertical-center">
                                <li class="list-group-item text-center">
                                    <button type="button"
                                            class="btn btn-pill btn-success btn-sm publicacion_eva_subir_material"
                                            data-lectura="2"
                                            data-id_alumno_inscrito_ctn_publicado="<?= $alumno->id_alumno_inscrito_ctn_publicado ?>">
