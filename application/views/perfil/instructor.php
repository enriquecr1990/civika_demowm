	...
	<section class="content">
		<div class="container-fluid">
			<div class="row">
				...
				<?php $this->load->view('perfil/default'); ?>
							...
							<div class="tab-content">
								...
								<div class="active tab-pane" id="mi_informacion">
									<div class="form-group row">
										<label class="col-sm-2">Usuario del sistema</label>
										<span class="col-sm-10"><?=isset($usuario) ? $usuario->usuario : ''?></span>
									</div>
									<?php if(isset($datos_usuario)):?>
										<div class="form-group row">
											<label class="col-sm-2">Nombre</label>
											<span class="col-sm-10"><?=$datos_usuario->nombre ?> <?=$datos_usuario->apellido_p?> <?=$datos_usuario->apellido_m?></span>
										</div>

										<div class="form-group row">
											<label class="col-sm-2">Genero</label>
											<span class="col-sm-10"><?=$datos_usuario->genero == 'm' ? 'Masculino' : 'Femenino'?></span>
										</div>

										<div class="form-group row">
											<label class="col-sm-2">Cumpleaños</label>
											<span class="col-sm-10"><?=isset($datos_usuario->fecha_nacimiento) && ($datos_usuario->fecha_nacimiento != '' || $datos_usuario->fecha_nacimiento != '0000-00-00') ? fecha_castellano_sin_anio($datos_usuario->fecha_nacimiento) : 'Sin dato'?></span>
										</div>

										<div class="form-group row">
											<label class="col-sm-2">Correo:</label>
											<span class="col-sm-10"><?=$datos_usuario->correo?></span>
										</div>

										<div class="form-group row">
											<label class="col-sm-2">Número de celular:</label>
											<span class="col-sm-10"><?=$datos_usuario->celular?></span>
										</div>

										<div class="form-group row">
											<label class="col-sm-2">Número de casa:</label>
											<span class="col-sm-10"><?=$datos_usuario->telefono?></span>
										</div>
										<div class="form-group row">
											<div class="col-sm-12 text-right">
												<button type="button" id="modificar_usuario_instructor"
														data-id_usuario="<?=isset($usuario) ? $usuario->id_usuario : $datos_usuario->id_usuario ?>"
									...
									<form id="actualizar_password_perfil">
										...
										<div class="form-group row">
											<div class="col-sm-7 text-right">
												<button type="button" id="btn_actualizar_password_perfil" data-id_usuario="<?=$datos_usuario->id_usuario?>"
