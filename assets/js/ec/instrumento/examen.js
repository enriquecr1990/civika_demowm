...
var Examen = {
	...
	enviar_formulario_respuestas : function(){
		Comun.enviar_formulario_post(
			...
			base_url + 'AlumnosEC/guardar_respuestas_instrumento',
			function(response){
				if(response.success){
					...
					'<div class="modal-content">' +
						...
						'<div class="modal-body">' +
							'<div class="callout callout-success">' +
								'<p>Se guardaron sus respuestas en el sistema correctamente; su calificación es de: <label class="" id="calificación_evaluacion"></label>' +
								'</p>' +
							'</div>' +
						'</div>' +
						'<div class="modal-footer justify-content-between">' +
							'<a href="'+base_url+'AlumnosEC/ver_progreso/'+id_estandar_competencia+'/'+id_usuario_evaluador+'" class="btn btn-sm btn-outline-primary btn_cerrar_confirmacion_evaluacion">Aceptar</a> ' +
						'</div>' +
					'</div>' +
					'<!-- /.modal-content -->' +
					'</div>' +
